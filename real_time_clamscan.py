...
# ==============================
# LOGGING SETUP (SEPARATE LOGGERS)
# ==============================
LOG_DIR = os.path.join(os.environ["USERPROFILE"], "ClamAV_Logs")
os.makedirs(LOG_DIR, exist_ok=True)

REALTIME_LOG_FILE = os.path.join(LOG_DIR, "clamav_realtime.log")
USB_LOG_FILE = os.path.join(LOG_DIR, "clamav_usb.log")
